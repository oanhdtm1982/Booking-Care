...
import 'package:doanchuyennganh/Screens/Welcome/Components/Keyboard.dart';
...
class _LoginState extends State<Login> {
                        ...
                        Row(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              onTap: () {
                                BlocProvider.of<EmailRegUserBloc>(context)
                                    .add(LoadEmailRegUser());
  ...
  void onSignInClicked(BuildContext context, String password) {
    ...
    BlocProvider.of<AuthBloc>(context)
        .add(SignInRequested(_userController.text, _passController.text));
  }
